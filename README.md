...
Mesa готовый deb пакет предложенный выше заменяет: mesa , libegl1-mesa-dev , mesa-common-dev , libgles2-mesa-dev , libosmesa6-dev , libgl1-mesa-dri:amd64 , libgl1-mesa-dri:i386 , libgbm-dev:amd64 , libegl1-mesa-dev , mesa-opencl-icd , mesa-va-drivers , libosmesa6:amd64 , libglapi-mesa:amd64 , libgl1-mesa-dev:amd64 , mesa-vdpau-drivers:amd64 , libglvnd-dev:amd64 , libegl1:amd64 , libgl1:amd64 , libgles1:amd64 , libgles2:amd64 , libxatracker2:amd64
